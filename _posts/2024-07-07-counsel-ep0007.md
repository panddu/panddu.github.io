...
category: comms
excerpt: "뚜쪽상담소 7편. ChatGPT로 만든 프로젝트를 포트폴리오로 써도 되는지, 대외활동은 많은데 전문성이 안 보이는 이력서를 어떻게 정리할지 등 10건의 질문과 답변입니다."
---

7편에서 처음으로 **AI 도구** 질문이 나왔습니다. 주변 안드로이드 개발자가 "ChatGPT가 알려주는 걸 복붙하고 조금만 연결하면 된다"고 말하는 걸 듣고, 그럼 나도 그렇게 프로젝트를 만들어도 되는지 묻는 사연이었습니다. 2024년 중반의 질문인데, 이후 회차에서 계속 확장되는 주제의 출발점이었습니다.

또 하나 인상적이었던 건 **활동은 많은데 전문성이 안 보이는 이력서**였습니다. 학점도 자격증도 잘 준비하고 대외활동을 열댓 개나 했는데, 활동마다 역할과 언어와 툴이 전부 달라서 무엇 하나에 대한 전문성으로 묶이지 않는다는 고민이었습니다. 이력서를 채우는 것과 이력서가 읽히는 건 다른 문제라는 이야기를 길게 했습니다.

풀스택 압박 질문도 있었습니다. 프론트엔드를 꾸준히 준비하는데 주변에서 백엔드도 같이 하라고 한다는 사연이었습니다.
...
<div class="qna-report">
  <section class="qna-card">
    <div class="qna-card__head">
      <h2 class="qna-card__theme">7편 — ChatGPT로 만든 프로젝트, 전문성이 안 보이는 이력서</h2>
