...
category: comms
excerpt: "뚜쪽상담소 6편. 6건을 길게 다뤘습니다. SI에서 얕고 넓게 쌓인 경력으로 서비스 회사에 가는 방법, 한 분야를 깊게 파는 것과 두루 잘하는 것 사이의 선택에 대한 이야기입니다."
---

6편은 질문 수가 6건으로 적었습니다. 대신 한 건씩 길게 다뤘습니다.

중심 주제는 **2차 전직**이었습니다. 대기업 SI 계열사에서 프론트·백엔드·CI/CD·QA를 혼자 다 하는 2년차, RPA 업체에서 백엔드와 AI 모델 서빙을 함께 해온 3년차 선임연구원 — 둘 다 "넓게는 해봤는데 깊이가 없다"는 같은 지점에 서 있었습니다.

그래서 이 회차에는 한 우물을 꾸준히 파는 사람과 두루 잘하는 육각형 인재 중 하나를 고르라면 무엇을 고르겠냐는 질문도 같이 들어왔습니다. 위의 두 사연과 묶어서 읽으면 좋은 질문이라, 답변에서 제 나름의 기준을 정리해봤습니다. 결론부터 말하면 저는 시점에 따라 답이 다르다고 봤습니다.
...
<div class="qna-report">
  <section class="qna-card">
    <div class="qna-card__head">
      <h2 class="qna-card__theme">6편 — SI에서 서비스 회사로, 한 우물 vs 육각형 인재</h2>
