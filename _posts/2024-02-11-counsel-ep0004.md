...
category: comms
excerpt: "뚜쪽상담소 4편. 일상 질문이 처음으로 많았던 회차 — 개발자의 눈 건강과 자취생 식사 문제부터, todoList를 넘어서는 포트폴리오와 비전공자의 CS 보강 방법까지 17건의 문답입니다."
---

4편은 성격이 좀 달랐습니다. 17건 중 7건이 일상 질문이었습니다. 개발자로 오래 모니터를 보면 눈이 어떻게 되는지, 자취하다 본가로 돌아온 사람의 식사 고민, 소소한 것에 만족하는 방법, 민초 논쟁, 자막을 영상에 그냥 렌더링해달라는 요청까지 들어왔습니다.

개발 질문은 **협업 경험의 부재**로 모였습니다. 졸업작품을 팀 단위로 하게 됐는데 깃을 아는 것과 팀으로 쓰는 게 다르다는 걸 깨달은 분, 리드해본 경험이 없는데 나중에 리드를 맡아야 할 때가 걱정되는 분, 사내시스템만 운영하다 보니 도전적이지 않은 환경에 놓였다는 분이 있었습니다.

포트폴리오 질문도 한 번 더 나왔습니다. 리액트로 만든 기본 CRUD todoList가 전부인데 여기서 무엇을 더해야 하냐는 질문이었습니다. 2편·3편에서도 비슷한 게 계속 올라와서, 이 회차 답변에서 제 기준을 조금 더 풀어서 적었습니다.
...
<div class="qna-report">
  <section class="qna-card">
    <div class="qna-card__head">
      <h2 class="qna-card__theme">4편 — 눈 건강과 자취 식사부터 팀 프로젝트 깃 협업까지</h2>
